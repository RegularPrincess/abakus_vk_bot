...
MSG_LEAVING = '😢 Сообщите, пожалуйса, причинк по которой вы покидайте нашу группу' \
...
MSG_LEAVE_REASON = "👉 Текущие возможные причины: \n\n {} " \
                   ...
                   "отправив новые, разделенные точкой с запятой (до 8 вариантов)\n\n" \
                   "👉 ПРИМЕР: Просто так; Надоела рассылка; Тема больше не интересна"
MSG_LEAVE_REASON_SAVED = "Причины отказа успешно сохранены (старые удалены). Количество - {}."
