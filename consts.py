...
MSG_ADRESSES_CHANGE = '👉 Для удаления отправте id офиса, для добавления нового - адрес офиса.' \
                      'ПРИМЕР: Красной Позиции, 2А, Казань, Республика Татарстан, Россия'
MSG_ADRESSES_REMOVED = 'Адрес успешно удален.'
MSG_ADRESS_ERROR = 'Не корректный адрес!'
MSG_ADRESS_SAVED = 'Адрес удален.'
