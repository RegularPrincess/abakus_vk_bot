...
BTN_ADDR_MSG_EDIT = "Ред-ть запрос адреса"
...
ADRESS_CHOOSE = 'Выберите адресс офиса из предложенных.'
...
MSG_ACCEPT_QUEST_MSG = '👉 Для удаления вопроса отправьте цифры ID. \n\
                       ...
                       '(Вопросы о телефне, адресе и email всегда присутствуют и выводятся в конце опроса)'
